...
def test_clearance_detects_obstacle_and_gate_opening():
    ...
    assert course.clearance(380.0, 0.0, 15.0, 1.1, 0.3) > 10.0
    assert course.clearance(380.0, 18.5, 15.0, 1.1, 0.3) < 0.0
    assert course.clearance(380.0, 33.5, 15.0, 1.1, 0.3) > 10.0
